...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Artists can fractionalize their royalties and sell them to fans as digital assets. Fans become part-owners and earn a share of the revenue when the music is streamed.",
  },
  {
